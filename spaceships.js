...
var imageRepository = new function() {
	...
	// Set images src
	this.background.src = "imgs/background.gif";
	this.spaceship.src = "imgs/UpperHull.png";
...
function Game() {
	...
	this.init = function() {
		...
		if (this.bgCanvas.getContext) {
			...
			this.gameOverAudio = new Audio("sounds/recharge.mp3");
...
function SoundPool(maxSize) {
	...
	this.init = function(object) {
		if (object == "laser") {
			for (var i = 0; i < size; i++) {
				// Initalize the object
				laser = new Audio("sounds/Star Wars laser.mp3");
				laser.volume = .12;
				laser.load();
				pool[i] = laser;
			}2
			...
			for (var i = 0; i < size; i++) {
				var explosion = new Audio("sounds/Star Wars Explosion.mp3");
				explosion.volume = .1;
				explosion.load();
				pool[i] = explosion;
			}
